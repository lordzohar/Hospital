	...
	if(mysqli_num_rows($result)>0 )
{
	...
	echo '<form name="Patient" action="index.php" method="get">';
	echo '<p><input type="submit" value="Click Here To Send Notification on Registered Email"></p>';
	echo '</form>';
